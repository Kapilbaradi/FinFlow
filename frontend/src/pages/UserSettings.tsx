...
const UserSettings = () => {
  return (
    <div>
      ...
      <div className="my-4">
        <div className="border-t-1 border-b-1 border-gray-400 p-4 flex items-center cursor-pointer">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <p className="px-2">Change UserName</p>
        </div>
        <div className="border-b-1 border-gray-400 p-4 flex items-center cursor-pointer">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <p className="px-2">Change Email</p>
        </div>
        <div className="border-b-1 border-gray-400 p-4 flex items-center cursor-pointer">
          <div>
            <svg
