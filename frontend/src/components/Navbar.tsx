...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex items-center justify-center sm:justify-start w-screen px-4 py-3 fixed top-0 left-0 sm:shadow sm:px-{30px}">
      ...
      <nav className="w-screen px-4 py-3 fixed bottom-0 left-0 flex items-center justify-between inset-shadow-xs sm:hidden">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
